...
(function() {
  $(function() {
    return $(document).on('change', '#shows_select', function(evt) {
      return $.ajax('update_price_categories', {
        type: 'GET',
        dataType: 'script',
        data: {
...
(function($) {
    ...
    $.widget('ui.tagit', {
        options: {
            ...
            caseSensitive     : false,
            fieldName         : 'tags',
            placeholderText   : "",   // Sets `placeholder` attr on input field.
...
(function() {
  $('#price_categories_select').empty().append("<%= escape_javascript(render(:partial => @price_categories)) %>");
